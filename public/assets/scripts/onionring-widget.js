...
<table>
  ...
  tag.insertAdjacentHTML('afterbegin', `
    <center>
    <class='webring-info'>This site is part of the ${ringName} webring</br>
    <span class='webring-links'>
      <class='webring-prev'><a href='${sites[previousIndex]}'>←</a>
      ${randomText}
      ${indexText}
      <a href='https://garlic.garden/onionring/'>what is this?</a></span>
    <class='webring-next'><a href='${sites[nextIndex]}'>→</a>
    </center>
  `);
